        ...
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              {/*content*/}
              <div className="  show-modal border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                {/*header*/}
                  ...
                  <div className="comment-card   ">
                    <div className="flex text-left mt-4">
                      <div className="ml-6 flex pr-10 ">
                        Annonymous rated{" "}
                        <div className="text-green-300"> 5 stars </div> and{" "}
                      </div>
                      <div className="text-green-400 ">commented</div>
                    </div>
                    <div className="text-yellow-400 ml-6 text-left">
                      Very Good Product
                    </div>
                  </div>
                </div>
