...
const Admin = () => {
  ...
  const callApi = async () => {
    try {
      let req = await fetch("https://04cb76fe-96cf-4ebe-a0c6-7a2435772034.eu-central-1.cloud.genez.io/api/v1/admin/get-admin-users", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      if (req.status === 403) {
        ...
        req = await fetch("https://04cb76fe-96cf-4ebe-a0c6-7a2435772034.eu-central-1.cloud.genez.io/api/v1/admin/get-admin-users", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const delUser = async (xxx) => {
    try {
      const req = await fetch(
        `https://04cb76fe-96cf-4ebe-a0c6-7a2435772034.eu-central-1.cloud.genez.io/api/v1/admin/user-delete/${xxx._id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
